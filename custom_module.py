...
class MAIN_MODULE_CLASS(COMMON_MAIN_MODULE_CLASS):
    def __init__(self, trigger_fxn, standalone = False):
        logger_config = {
            'log_file_name': 'custom_module_log.txt',
            'print_to_stdout': True,
            'stdout_prefix': 'CUSTOM_MODULE'
        }
        config_params = { 
            'config_file_name':'custom_module_cfg.json',
            'default_config': {}
        }
        ...
        self._print('Initializing custom module...')
    ...
    def main(self):
        ...
        p = Popen(['python3', '/var/lib/cloud9/trigger/trigger_main.py'], preexec_fn=os.setsid)
        ...
        while (not self.shutdown_event.is_set()):
            # set message
            self.message = 'Starting custom module...'
            sleep(1)
        ...
        #self.set_config(self.get_config())
        self._print('custom module thread exited')
